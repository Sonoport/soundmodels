...
@constructor
**/
function SPAudioParam(name, minValue, maxValue, defaultValue, aParam,mapping){
  "use strict";
  /**
  ...
  **/
  this.setTargetValueAtTime = function (values,startTime,duration){
    if(typeof mapping === 'function'){
      var index = 0;
    ...
    if (aParam){
      aParam.setTargetAtTime(values,startTime, duration);
    }else{
      //TODO Add logic
    }
  }
