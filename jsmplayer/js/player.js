...
( function () {
    ...
    $( document )
        .ready( function () {
            ...
            console.log( "mc", modelClass, modelURL );
    ...
    function swapModels( mc, url ) {
        ...
        require( [ "core/SPAudioParam", url ], function ( SPAudioParam, Model ) {
